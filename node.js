...
var createLoader = function createLoader() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      resolve = _ref$resolve === void 0 ? RegisterLoader.prototype[RegisterLoader.resolve] : _ref$resolve,
      _ref$instantiate = _ref.instantiate,
      instantiate = _ref$instantiate === void 0 ? RegisterLoader.prototype[RegisterLoader.instantiate] : _ref$instantiate;

  var loader = new RegisterLoader();

  if (base) {
    base = resolveIfNotPlain(base, baseURI) || resolveIfNotPlain("./".concat(base), baseURI);
  } else {
    base = baseURI;
  }
...
var fetchModuleFromServer = function fetchModuleFromServer(key) {
  if (key.indexOf("http:") === 0 || key.indexOf("https:") === 0) {
    return fetch(key, {
      headers: {
        "user-agent": "node/".concat(process.version.slice(1))
      }
...
var fetchModule = function fetchModule(key) {
  return Promise.resolve(fetchModuleFromFileSystem(key)).then(function (data) {
    return data ? data : Promise.resolve(fetchModuleFromServer(key)).then(function (data) {
      ...
      throw new Error("unsupported protocol for module ".concat(key));
    });
  });
};
...
var createNodeLoader = function createNodeLoader() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      getFilename = _ref$getFilename === void 0 ? function (key) {
    return key;
  } : _ref$getFilename;
  ...
  return createLoader({
    ...
    instantiate: function instantiate(key, processAnonRegister) {
      if (isNodeBuiltinModule(key)) {
        ...
        var bindings = _objectSpread({}, nodeBuiltinModuleExports, {
      ...
      return fetchModule(key).then(function (_ref2) {
        ...
        var script = new vm.Script(source, {
          filename: getFilename(key, location)
        });
